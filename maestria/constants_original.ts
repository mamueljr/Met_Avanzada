...
export const PILLARS: Pillar[] = [
  ...
  },
  {
    ...
    description: '8 cursos-taller prácticos distribuidos en 4 semestres.',
  ...
  {
    id: 4,
    title: 'Seminarios de Socialización de Proyectos de Tesis',
    description: 'Espacios académicos formales para presentar avances.',
    whatIsIt: 'Inician en el segundo semestre, donde presentas tus avances ante profesores, compañeros e investigadores invitados.',
    benefits: [
...
export const SEMESTERS: Semester[] = [
  {
    ...
    courses: [
      ...
      'Construcción de Instrumentos de Autorreporte',
      'Validación de Contenido de Cuestionarios de Autorreporte',
  ...
  },
  {
    ...
    courses: [
      ...
      'Validación de Estructuras Latentes',
      'Seminario de Proyecto de Tesis I',
      'Socialización de Proyectos de Tesis I'
    ]
  },
  {
    id: 3,
    title: 'Semestre 3',
    courses: [
      'Seminario de Metodología Optativo I',
      'Seminario de Especialización en Área de Investigación Elegida I',
      'Seminario de Proyecto de Tesis II',
      'Socialización de Proyectos de Tesis II'
    ]
  },
  {
    id: 4,
    title: 'Semestre 4',
    courses: [
      'Seminario de Metodología Optativo II',
      'Seminario de Especialización en Área de Investigación Elegida II',
      'Taller de Redacción y Defensa del Trabajo de Grado',
      'Socialización de Proyectos de Tesis III'
    ]
  }
];
...
export const STATS: Stat[] = [
  { value: '4', label: 'Semestres', subtext: '2 años de duración' },
  { value: '100%', label: 'En Línea', subtext: 'Reuniones cada 15 días' },
  { value: '16', label: 'Espacios Curriculares', subtext: 'Totalmente prácticos' },
