      ...
      <div className="bg-uach-purple py-20">
        <div className="container mx-auto px-4 text-center max-w-4xl">
           ...
           <p className="text-xl text-indigo-100 mb-8">
             Únete a la Maestría en Metodología Avanzada y conviértete en el investigador de excelencia que el mundo necesita.
           </p>
           <p className="text-lg text-white/80 mb-10 leading-relaxed font-light">
            Este programa de maestría está diseñado para formar investigadores de excelencia que contribuyan significativamente al avance del conocimiento en Ciencias Sociales, Humanidades, Educación y Salud.
           </p>
