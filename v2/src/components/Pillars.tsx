      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid gap-12">
            {PILLARS.map((pillar, index) => (
                <div 
                    key={pillar.id} 
                    className={`flex flex-col md:flex-row gap-8 items-start ${index % 2 === 1 ? 'md:flex-row-reverse' : ''} fade-in-up`}
                ...
                >
                    ...
                    {/* Content */}
                    <div className="flex-1 bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-shadow border border-gray-100 glow-border hover-lift">
