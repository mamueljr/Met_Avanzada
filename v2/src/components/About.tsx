    ...
    <section id="que-es" className="py-20 bg-white">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div className="rounded-2xl overflow-hidden shadow-2xl transform hover:scale-[1.02] transition-transform duration-500 fade-in-up" style={{ animationDelay: '0.1s' }}>
                <img 
                    src={aboutImg} 
            ...
            <div className="space-y-8">
                ...
                <div className="flex gap-4 fade-in-up" style={{ animationDelay: '0.3s' }}>
                    <div className="flex-shrink-0 mt-1">
                        <div className="w-12 h-12 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 transition-colors duration-300 hover:bg-indigo-200 hover:text-indigo-700">
                            <Users size={24} />
                        </div>
                ...
                <div className="flex gap-4 fade-in-up" style={{ animationDelay: '0.4s' }}>
                    <div className="flex-shrink-0 mt-1">
                        <div className="w-12 h-12 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 transition-colors duration-300 hover:bg-indigo-200 hover:text-indigo-700">
                            <TrendingUp size={24} />
                        </div>
