        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0 flex items-center gap-2 cursor-pointer">
            ...
            <div className="flex flex-col">
              <span className={`font-bold leading-tight ${scrolled ? 'text-uach-purple' : 'text-white'}`}>Especialidad DVCA-FCCF</span>
            ...
            <div className="ml-10 flex items-baseline space-x-6">
              {NAV_ITEMS.map((item) => (
                <a
                  key={item.label}
                  href={item.href}
                  className={`relative text-sm font-medium transition-colors hover:text-uach-gold ${scrolled ? 'text-gray-700' : 'text-white/90'
