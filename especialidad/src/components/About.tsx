      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-uach-purple mb-4">
            ¿Qué es la Maestría en Metodología Avanzada?
          </h2>
          <div className="w-24 h-1 bg-uach-gold mx-auto"></div>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <RevealOnScroll delay={0.1} className="rounded-2xl overflow-hidden shadow-2xl transform hover:scale-[1.02] transition-transform duration-500">
                <img 
                    src={aboutImg} 
                    alt="Estudiantes de maestría colaborando" 
                ...
                <RevealOnScroll delay={0.2}>
                  <div className="flex gap-4">
                      <div className="flex-shrink-0 mt-1">
                          <div className="w-12 h-12 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 transition-colors duration-300 hover:bg-indigo-200 hover:text-indigo-700">
                              <Target size={24} />
                          </div>
                      </div>
                      <div>
                          ...
                          <p className="text-gray-600 leading-relaxed">
                              ...
                              A diferencia de las maestrías tradicionales que se enfocan solo en el contenido disciplinar, 
