...
export const PILLARS: Pillar[] = [
  {
    id: 1,
    title: 'Seminarios de la Opción Terminal Elegida',
    description: 'Acompañamiento individualizado para tu proyecto de investigación.',
    whatIsIt: 'Los Seminarios de la Opción Terminal Elegida son espacios donde profundizas en el conocimiento teórico, epistemológico y metodológico de tu área. Se te guía desde la formulación de tus preguntas de investigación hasta la publicación de tus resultados.',
    benefits: [
  ...
  },
  {
    ...
    description: '5 cursos-taller prácticos distribuidos en 2 semestres.',
...
export const SEMESTERS: Semester[] = [
  {
    ...
    courses: [
      ...
      'Búsqueda y Síntesis de Literatura Científica de la Opción Terminal Elegida'
    ]
  },
  {
    id: 2,
    ...
    courses: [
      ...
      'Suficiencia Investigadora de la Opción Terminal Elegida'
    ]
  }
];
...
export const STATS: Stat[] = [
  ...
  { value: '22', label: 'Espacios Curriculares', subtext: 'Totalmente prácticos' },
  { value: '9', label: 'Áreas', subtext: 'De formación específica' }
];
